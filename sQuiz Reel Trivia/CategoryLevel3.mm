...
#define CAT1 @"Adventure"
#define CAT2 @"Animation"
#define CAT3 @"Thriller"
...
+(id) scene:(int) saveSlot lvl:(int)levelNumber {
	...
	CategoryLevel3 *layer = [CategoryLevel3 node];
...
-(id) init {
	if ((self = [super init])) {
        ...
        Level1NoTextSpriteSheet = [[CCTextureCache sharedTextureCache] addImage:@"Level3BGText.pvr"];
        [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"Level3BGText.plist" texture:Level1NoTextSpriteSheet];
...
-(void) categoryMenu {
	...
	ActionButton = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithSpriteFrameName:[NSString stringWithFormat:@"%@Text.png", CAT1]] selectedSprite:nil target:target selector:@selector(LaunchLevel:)];
	...
	ComedyButton = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithSpriteFrameName:[NSString stringWithFormat:@"%@Text.png", CAT2]] selectedSprite:nil target:target selector:@selector(LaunchLevel:)];
	...
	DramaButton = [CCMenuItemSprite itemFromNormalSprite:[CCSprite spriteWithSpriteFrameName:[NSString stringWithFormat:@"%@Text.png", CAT3]] selectedSprite:nil target:target selector:@selector(LaunchLevel:)];
    ...
    warning = [CCLabelTTF labelWithString:@"" fontName:@"Broadway BT" fontSize:15.0 dimensions:CGSizeMake(200,150) hAlignment:kCCTextAlignmentCenter];
...
/*-(void) changeLabelStat:(id) sender {
 switch (categoryScroller.currentScreen) {
 case 1:
 //show stats for action
 //CategoryReviewBG
